...
let color = prompt("What color do you want? (Choose Red or Blue)");
let value = Number(prompt("What value do you want? (Choose a number 1-12"));

let selectedCards = responseMessage.Cards.filter (item => item.Color === color && item.Value === value) ;
